...
PROJECT_BASE = os.path.dirname(os.path.dirname(DJANGO_BASE))
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'adb.frontend.collection.context_processors.letters',
)
...
ROOT_URLCONF = 'adb.frontend.urls'
...
INSTALLED_APPS = (
    ...
    'adb.frontend.auth',
    'adb.frontend.collection',
    'adb.frontend.lists',
    'adb.frontend.checker',
    'haystack',
)
